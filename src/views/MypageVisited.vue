        ...
        <div class="review-section">
          ...
          <ul class="pagination justify-content-center">
            <li class="page-item" v-if="prev">
              <router-link :to="`/myPageVisited?no=${currentPageIndex - 1}`" class="page-link" aria-label="Previous">
            ...
            <li class="page-item" v-if="next">
              <router-link :to="`/myPageVisited?no=${currentPageIndex + 1}`" class="page-link" aria-label="Next">
