...
export { default as FeatureOne } from "./feature/FeatureOne.vue";
export { default as FeatureTwo } from "./feature/FeatureTwo.vue";
...
export { default as TestimonialOne } from "./testimonial/TestimonialOne.vue";

export { default as ChooseOne } from "./chooseus/ChooseOne.vue";
export { default as ChooseTwo } from "./chooseus/ChooseTwo.vue";

export { default as BlogOne } from "./blog/BlogOne.vue";

export { default as CTAOne } from "./cta/CTAOne.vue";
export { default as CTATwo } from "./cta/CTATwo.vue";

export { default as CounterOne } from "./counter/CounterOne.vue";
export { default as CounterTwo } from "./counter/CounterTwo.vue";
